...
export const metadata: Metadata = {
  title: "Money-back policy — HyperUp",
  description: "Subscription, billing, and cancellation terms for HyperUp.",
};
      ...
      <main className="relative flex flex-1 flex-col overflow-visible px-5 pb-16 pt-11 md:px-8 md:pb-24 md:pt-16">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1280px]">
          <div className="mx-auto w-full max-w-[335px] text-center md:max-w-[768px]">
            ...
            <h1 className="mt-1 text-balance text-[48px] font-semibold leading-[60px] tracking-[-0.96px] text-[#101828] md:mt-4">
              {content.title}
            </h1>
          </div>
